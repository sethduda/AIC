...
_alphaScript = "['"+_groupControlId+"','ALPHA_GO_CODE_SELECTED'] spawn AIC_fnc_groupControlEventHandler";
_bravoScript = "['"+_groupControlId+"','BRAVO_GO_CODE_SELECTED'] spawn AIC_fnc_groupControlEventHandler";
_goBackScript = "['"+_groupControlId+"'] spawn AIC_fnc_showGroupCommandMenu";
	
AIC_Group_Go_Code_Menu = [
...
showCommandingMenu "";
showCommandingMenu "#USER:AIC_Group_Go_Code_Menu";