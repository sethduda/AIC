...
_redScript = "['"+_groupControlId+"','CHANGE_COLOR',[AIC_COLOR_RED]] spawn AIC_fnc_groupControlEventHandler";
_blueScript = "['"+_groupControlId+"','CHANGE_COLOR',[AIC_COLOR_BLUE]] spawn AIC_fnc_groupControlEventHandler";
_greenScript = "['"+_groupControlId+"','CHANGE_COLOR',[AIC_COLOR_GREEN]] spawn AIC_fnc_groupControlEventHandler";
_blackScript = "['"+_groupControlId+"','CHANGE_COLOR',[AIC_COLOR_BLACK]] spawn AIC_fnc_groupControlEventHandler";
_whiteScript = "['"+_groupControlId+"','CHANGE_COLOR',[AIC_COLOR_WHITE]] spawn AIC_fnc_groupControlEventHandler";
...
AIC_Group_Color_Menu = [
		...
		["Red", [0], "", -5, [["expression", '["'+_redScript+'"] spawn AIC_fnc_commandMenuAction']], "1", "1"],
		["Green", [0], "", -5, [["expression", '["'+_greenScript+'"] spawn AIC_fnc_commandMenuAction']], "1", "1"],
		["Blue", [0], "", -5, [["expression", '["'+_blueScript+'"] spawn AIC_fnc_commandMenuAction']], "1", "1"],
		["White", [0], "", -5, [["expression", '["'+_whiteScript+'"] spawn AIC_fnc_commandMenuAction']], "1", "1"],
		["Black", [0], "", -5, [["expression", '["'+_blackScript+'"] spawn AIC_fnc_commandMenuAction']], "1", "1"],
